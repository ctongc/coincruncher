...
class Clicker: SKSpriteNode {
    
    init(direction: String) {
        let tex = SKTexture(imageNamed: "ClickerNode-"+direction+"-1")
    ...
    func animate(direction: String) {
        let f0 = SKTexture.init(imageNamed: "ClickerNode-"+direction+"-1")
        let f1 = SKTexture.init(imageNamed: "ClickerNode-"+direction+"-2")
        let f2 = SKTexture.init(imageNamed: "ClickerNode-"+direction+"-3")
